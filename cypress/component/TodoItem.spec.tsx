...
beforeEach(() => {
  cy.window().then((win) => {
    ...
    (win as Window & { toast?: typeof mockToast }).toast = mockToast;
  });
...
describe("TodoItem Component", () => {
  ...
  it("should show completed state correctly", () => {
    ...
    mount(
      <TodoItem todo={completedTodo} userId={mockUserId} onUpdate={onUpdate} />,
    );
    ...
    cy.contains(completedTodo.title).parent().should(
      "have.class",
      "line-through",
    );
  });
  ...
  it("should display created date", () => {
    ...
    cy.contains(mockTodo.createdAt.toDate().toLocaleDateString()).should(
      "be.visible",
    );
  });
});
